classdef compte_ds_mainen
    ...
    methods
        ...
        function o = compte_ds_mainen(params,Var,varargin)
            o.p = params;
        ...
        function dif = dssGABA(o)
            ...
            dif = o.p.alphaGABA .* (o.p.WIEs * o.ff(o.Vi)) - o.ssGABA./o.p.tauGABA;
        end
        function dif = dsdGABA(o)
            %                 dif = o.p.alphaGABA .* (o.p.WII * o.ff(o.Vi)) .* (1 - o.siGABA) - o.siGABA./o.p.tauGABA;
            dif = o.p.alphaGABA .* (o.p.WIEd * o.ff(o.Vi))  - o.sdGABA./o.p.tauGABA;
        end
