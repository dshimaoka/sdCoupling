classdef compte
    ...
    properties
        ...
        methods
            ...
            function o = compte(params,Var,varargin)
                o.p = params;
                ...
                o.xdNMDA = Var(6*o.p.Ne+1:7*o.p.Ne,:);%second messenger for NMDA receptor channels on dendrite of excitatory neuron
                o.sdNMDA = Var(7*o.p.Ne+1:8*o.p.Ne,:);%fraction of open NMDA receptor channels on dendrite of excitatory neuron
                o.h = Var(8*o.p.Ne+1:9*o.p.Ne,:);%sodium channel for soma of excitatory neuron
                o.n = Var(9*o.p.Ne+1:10*o.p.Ne,:);%delayed rectifier channel for soma of excitatory neuron
                o.ha = Var(10*o.p.Ne+1:11*o.p.Ne,:);%fast A-type sodium channel for soma of excitatory neuron
                o.mks = Var(11*o.p.Ne+1:12*o.p.Ne,:);%non-inactivating sodium channel for soma of excitatory neuron
            ...
            function currentDensity = IL(o)
                %leak current (soma)
                currentDensity = o.p.gL .* (o.Vs - o.p.VL); %[1e-2 * A/m^2]
            end
            ...
            function current = Isynd(o) %[1e-8 A]
                ...
                current = 1e-4 * (o.p.gEEAMPA .* o.sdAMPA .* (o.Vd - o.p.VsynAMPA) ...
                    + o.p.gEENMDA .* o.sdNMDA .* (o.Vd - o.p.VsynNMDA));
            end
...
%                  dif= o.p.alphaAMPA .* (o.p.WEE * o.ff(o.Vs)) .* (1-o.sdAMPA) - o.sdAMPA./o.p.tauAMPA;% Tegner 2002
                 dif= o.p.alphaAMPA .* (o.p.WEE * o.ff(o.Vs)) - o.sdAMPA./o.p.tauAMPA;%Pinsky 1994; Compte 2003
            end
            
            function dif = dxdNMDA(o)
                dif = o.p.alphaxNMDA .* (o.p.WEE * o.ff(o.Vs)) - o.xdNMDA./o.p.tauxNMDA; %wang 1999 eq(4); Compte 2003
            end
            ...
            function dif = dsdNMDA(o)
                %                  dif = o.p.alphasNMDA .* o.xdNMDA .* (1 - o.sdNMDA) - o.sdNMDA./o.p.tausNMDA; %Tegner 2002; added xiNMDA to Compte 2003
                 ...
                 dif = o.p.alphasNMDA .* (1 - o.sdNMDA) .* (o.p.WEE * o.ff(o.Vs)) - o.sdNMDA./o.p.tausNMDA; %added network input to Compte 2003
            end
...
%                 dif = o.p.alphaGABA .* (o.p.WII * o.ff(o.Vi)) .* (1 - o.siGABA) - o.siGABA./o.p.tauGABA;
            ...
            function dif = dni(o) %persistent
             ...
             function dif = dVs(o, extCurrent) %[mV]
                 ...
                 dif = (-o.p.As.*(o.IL+o.INa+o.IK+o.IA+o.IKS+o.IKNa) ...
                     - o.Isyns - 0.1*o.p.gsd.*(o.Vs-o.Vd) + 0.1*extCurrent)./o.p.Cm./o.p.As; %+ 0.025
             end
             
             function dif = dVd(o) %[mV]
                 %dendrite of excitatory neuron
                 dif = (-o.p.Ad.*(o.ICa+o.IKCa+o.INaP+o.IAR) ...
                     - o.Isynd - 0.1*o.p.gsd.*(o.Vd-o.Vs))./o.p.Cm./o.p.Ad;
             end
            ...
            function allDif = dVar(o)
                ...
                allDif(6*o.p.Ne+1:7*o.p.Ne,1) = o.dxdNMDA;%second messenger for NMDA receptor channels on dendrite of excitatory neuron
                allDif(7*o.p.Ne+1:8*o.p.Ne,1) = o.dsdNMDA;%fraction of open NMDA receptor channels on dendrite of excitatory neuron
                allDif(8*o.p.Ne+1:9*o.p.Ne,1) = o.dh;%sodium channel for soma of excitatory neuron
                allDif(9*o.p.Ne+1:10*o.p.Ne,1) = o.dn;%delayed rectifier channel for soma of excitatory neuron
                allDif(10*o.p.Ne+1:11*o.p.Ne,1) = o.dha;%fast A-type sodium channel for soma of excitatory neuron
                allDif(11*o.p.Ne+1:12*o.p.Ne,1) = o.dmks;%non-inactivating sodium channel for soma of excitatory neuron
            ...
            function conductance = condSyn_exc(o) %correct?
                %total excitatory synaptic conductance of dendrite[nS]
                conductance = o.p.gEEAMPA .* o.sdAMPA + o.p.gEENMDA .* o.sdNMDA;
            end
